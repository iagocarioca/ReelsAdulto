			...
			<section class="xf-secao">
				<div class="xf-plhead">
					...
					<div class="xf-plhead__info">
						...
						<h1 class="xf-plhead__title"><?php if ( function_exists( 'tikporn_icone_playlist_titulo' ) ) { tikporn_icone_playlist_titulo(); } ?><?php echo esc_html( get_post_field( 'post_title', get_the_ID() ) ); ?></h1>
